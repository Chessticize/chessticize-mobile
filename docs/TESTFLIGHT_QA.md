...
This document preserves an optional 1.5.0 TestFlight diagnostic checklist and
...
- Source commit: the commit pointed to by the `ios-v1.5.0-build-1` tag
- Release tag:
  [`ios-v1.5.0-build-1`](https://github.com/Chessticize/chessticize-mobile/releases/tag/ios-v1.5.0-build-1)
...
| Field | Value |
| --- | --- |
| Source commit | Tag target for `ios-v1.5.0-build-1` |
| Release tag | `ios-v1.5.0-build-1` |
...
step. The 1.5.0 upload path uses `xcodebuild archive`, then
