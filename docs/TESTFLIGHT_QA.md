...
This document preserves an optional 1.3.4 TestFlight diagnostic checklist and
...
| What to test | `Resize the iPad app on Apple silicon Mac and verify Practice navigation remains readable in wide, compact windows.` |
...
- Source commit: the commit pointed to by the `ios-v1.3.4-build-1` tag
- Release tag:
  [`ios-v1.3.4-build-1`](https://github.com/Chessticize/chessticize-mobile/releases/tag/ios-v1.3.4-build-1)
...
| Field | Value |
| --- | --- |
| Source commit | Tag target for `ios-v1.3.4-build-1` |
| Release tag | `ios-v1.3.4-build-1` |
...
step. The 1.3.4 upload path uses `xcodebuild archive`, then
