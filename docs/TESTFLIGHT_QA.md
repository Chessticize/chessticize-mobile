...
- Source commit: the commit pointed to by the `ios-v1.3.5-build-1` tag
- Release tag:
  [`ios-v1.3.5-build-1`](https://github.com/Chessticize/chessticize-mobile/releases/tag/ios-v1.3.5-build-1)
...
| Field | Value |
| --- | --- |
| Source commit | Tag target for `ios-v1.3.5-build-1` |
| Release tag | `ios-v1.3.5-build-1` |
