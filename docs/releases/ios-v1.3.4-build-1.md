...
- Source tag: `ios-v1.3.4-build-1`
- Previous public source tag: `ios-v1.3.3-build-1`

## Customer-facing changes

- Improve iPad app window sizing when running on Apple silicon Mac.
...
- [GitHub Release](https://github.com/Chessticize/chessticize-mobile/releases/tag/ios-v1.3.4-build-1)

## GitHub customer summary

Chessticize 1.3.4 improves iPad app window sizing on Apple silicon Mac and
keeps Practice navigation readable in wide, compact windows.
