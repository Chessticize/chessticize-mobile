...
- iPad app on Mac window: minimum 820 × 600 points and maximum width of 1376 points;
  height keeps the system maximum
...
an 820 × 600 point minimum and a maximum width of 1376 points. Height keeps the
system maximum so tall desktop windows are not constrained, while the width cap
still covers both the 13-inch iPad portrait size (1032 × 1376) and landscape
size (1376 × 1032) without encouraging arbitrarily wide desktop layouts. These
