...
This document is the 1.3.3 source of truth for App Store Connect metadata and
...
For iOS 1.3.3, review this proposed ready-to-paste copy:
...
This copy belongs to the proposed `ios-v1.3.3-build-1` release identity and
must match `docs/releases/ios-v1.3.3-build-1.md` before the owner marks that
...
The app targets iPhone and iPad for 1.3.3. The current automated capture plan
...
The 1.3.3 Replay, Tactical Progress, and solved-prompt presentation changes
require a fresh exact-head Release capture and inspection before upload. Do not
reuse the 1.3.2 set as final 1.3.3 visual evidence.
