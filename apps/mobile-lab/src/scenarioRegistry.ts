...
const scenarioDefinitions: Record<LabScenarioId, LabScenarioMetadata> = {
  ...
  "practice-arrow-duel-terminal-other-move": defineScenario("practice-arrow-duel-terminal-other-move", "Practice", "Arrow Duel · terminal other move", "practice--arrow-duel-terminal-other-move-no-reply", "A deterministic test-only scenario pairs the correct Qg7 checkmate choice with Qf7 stalemate as the other move. Because that alternative position has no legal reply, the production rule passes the puzzle immediately without a preparation cue, reply prompt, countdown, or timeout path.", "practice", ["Legal Qg7 and Qf7 candidates", "Correct Qg7 checkmate choice", "Qf7 stalemate detection", "Immediate pass", "No preparation cue", "No reply prompt", "No reply countdown", "No reply timeout"], ["Review scheduling"], "contained"),
