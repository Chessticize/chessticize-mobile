...
const scenarioDefinitions: Record<LabScenarioId, LabScenarioMetadata> = {
  ...
  "practice-active-session-guide": defineScenario("practice-active-session-guide", "Practice", "Active session · first-use guide", "practice--active-session-guide", "Four-step spotlight tour shown before the timer starts. The frozen demonstration preserves the real Sprint hierarchy while using a height-aware portrait board and board-side landscape callouts so the taught control and guide navigation remain visible.", "practice", ["No real session chessboard during guidance", "Frozen real-Sprint composition", "Height-aware portrait board", "Board-side Slow and Unclear callouts in landscape", "Shared session header, prompt, timer, score, and Unclear components", "Four-step Back and Next tour", "Current target stays bright while unrelated UI is dimmed", "Slow timer turns amber automatically", "Timed out appears over the board, marks Unclear, counts as a mistake, and enters Review", "Start Sprint only on the final step"], ["Production onboarding persistence", "Active Sprint"], "contained"),
  "practice-arrow-duel-guide": defineScenario("practice-arrow-duel-guide", "Practice", "Arrow Duel · step 5 after shared guide", "practice--arrow-duel-guide", "First-ever app entry through Arrow Duel becomes one continuous five-step tour: the four responsive shared Active Session explanations come first, then a frozen real Arrow Duel composition explains the two candidate arrows as a single-line step 5 of 5.", "practice", ["Steps 1–4: responsive shared Active Session guide", "Step 5: frozen real Arrow Duel composition", "Height-aware portrait board and shared session components", "Single-line guide progress", "Real candidate-arrow overlay", "Back returns from step 5 to step 4", "No real session position during guidance", "Start Arrow Duel after step 5"], ["Production onboarding persistence", "Arrow Duel Sprint"], "contained"),
  "practice-arrow-duel-guide-only": defineScenario("practice-arrow-duel-guide-only", "Practice", "Arrow Duel · single first-use step", "practice--arrow-duel-guide-only", "A user who already knows the shared Active Session controls sees one responsive Arrow Duel-specific step the first time they enter the mode. The height-aware frozen real session composition explains the only two candidate moves before the timer starts.", "practice", ["One step: 1 of 1", "Height-aware frozen real Arrow Duel composition", "Shared session components", "Single-line guide progress", "Real candidate-arrow overlay", "Only the two shown moves count", "No real session position during guidance", "Start Arrow Duel"], ["Production onboarding persistence", "Arrow Duel Sprint"], "contained"),
