...
const scenarioDefinitions: Record<LabScenarioId, LabScenarioMetadata> = {
  ...
  "history-filters": defineScenario("history-filters", "History", "Filters and active filters", "history--filters-and-active-filters", "One framed advanced-filter region above the Needs attention or All selector, with a lightweight Themes disclosure that names selections while the applied summary stays compact.", "history", ["Framed advanced filters", "Needs attention default", "All sources default", "Selected theme names above", "Compact theme count below", "Collapsed 24-theme catalog", "Reset"], ["Replay puzzle"]),
