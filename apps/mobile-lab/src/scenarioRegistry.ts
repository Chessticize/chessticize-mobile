...
const scenarioDefinitions: Record<LabScenarioId, LabScenarioMetadata> = {
  ...
  "practice-home-edit": defineScenario("practice-home-edit", "Practice", "Edit and reorder runs", "practice--edit-and-reorder-runs", "Home edit mode with a full-size card that follows the pointer, a lifted picked-up state, a medium-haptic pickup preview, a single insertion line before drop, animated settling, arrow-button fallbacks, Run edit actions, and removal actions.", "practice", ["Pointer-following whole-card drag", "Suppressed browser drag ghost", "Lifted picked-up card", "Medium pickup haptic preview", "Insertion-line target", "Animated drop settlement", "Arrow-button fallback", "Run edit actions", "Format-specific icons", "Removal entry"], ["Native haptic feel validation", "Run editor", "Removal confirmation", "Practice home"]),
