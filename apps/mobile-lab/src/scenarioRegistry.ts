...
const scenarioDefinitions: Record<LabScenarioId, LabScenarioMetadata> = {
  ...
  "review-due": defineScenario("review-due", "Review", "Home", "review--due-queue", "The Review tab home keeps today's scheduled retries prominent while making both Today and Completed sections collapsible, with visible counts, a distinct retry icon, prior attempt and miss counts, and concise attempt recency.", "review", ["Review Home", "Due metrics", "Forecast", "Main Review action", "Today to review expanded by default", "Completed today collapsed by default", "Section counts and chevrons", "Blue retry icon", "Attempt count", "Miss count", "First-miss recency", "Last-retry recency"], ["Production review-history derivation", "Review session", "Practice"]),
