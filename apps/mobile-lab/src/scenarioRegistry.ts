...
const scenarioDefinitions: Record<LabScenarioId, LabScenarioMetadata> = {
  ...
  "review-arrow-duel-reply": defineScenario("review-arrow-duel-reply", "Review", "Arrow Duel reply", "review--arrow-duel-reply", "Scheduled Arrow Duel Review inherits the Run's enabled Opponent reply rule and twelve-second fixture setting. After the fixed 1.5-second What if you made the other move? handoff becomes playable, Review starts that same countdown; either stage must pass for the Review to pass, and timeout receives a visible Timed out handoff before Review advances.", "review", ["Existing Review session", "Stored candidate order", "1.5-second What if you made the other move? handoff", "Run-configured twelve-second countdown", "Countdown starts at input unlock", "Visible Timed out handoff", "One Review result for both stages"], ["Review queue", "Replay"], "contained"),
