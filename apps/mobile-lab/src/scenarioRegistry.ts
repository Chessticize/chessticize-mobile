...
const scenarioDefinitions: Record<LabScenarioId, LabScenarioMetadata> = {
  ...
  "practice-active-session-guide": defineScenario("practice-active-session-guide", "Practice", "Active session · first-use guide", "practice--active-session-guide", "Board-free first-session guide shown before the timer starts, using compact session metrics plus real Slow, Timeout, Review, and Unclear language without revealing a puzzle position.", "practice", ["No chessboard during guidance", "Timer starts after guide", "Solved, timer, and mistake metrics", "Slow automatically marks Unclear", "Timeout adds to Review", "Mark as unclear button explanation", "Start Sprint"], ["Production onboarding persistence", "Active Sprint"], "contained"),
  "practice-arrow-duel-guide": defineScenario("practice-arrow-duel-guide", "Practice", "First-ever Arrow Duel · both guides", "practice--arrow-duel-guide", "First-ever app entry through Arrow Duel: the board-free shared Active Session guide comes first, followed by the mode-specific Arrow Duel guide, and the timer starts only after both.", "practice", ["Guide 1 of 2: shared Active Session rules", "Guide 2 of 2: Arrow Duel candidates", "No chessboard during guidance", "Timer starts after both guides", "Start Arrow Duel"], ["Production onboarding persistence", "Arrow Duel Sprint"], "contained"),
  "practice-arrow-duel-guide-only": defineScenario("practice-arrow-duel-guide-only", "Practice", "Arrow Duel guide only · Sprint guide seen", "practice--arrow-duel-guide-only", "Returning-user path for someone who has already seen the shared Active Session guide but is entering Arrow Duel for the first time.", "practice", ["Mode-specific guide only", "Two candidate illustration", "Only shown candidates count", "No chessboard during guidance", "Start Arrow Duel"], ["Production onboarding persistence", "Arrow Duel Sprint"], "contained"),
