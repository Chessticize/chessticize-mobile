...
const scenarioDefinitions: Record<LabScenarioId, LabScenarioMetadata> = {
  ...
  "practice-personal-best-records": defineScenario("practice-personal-best-records", "Practice", "Survival · records", "practice--personal-best-records", "Survival records live directly on a dedicated full page reached from the Challenge Hub, keeping ordinary History focused on puzzle attempts. A fresh profile truthfully explains that one solved puzzle sets the first best, while Puzzle and Arrow Duel remain separate at each level. The existing Back action returns to setup without adding a redundant Start action.", "practice", ["Dedicated full Survival page", "Fresh-profile empty state", "One solve sets first best", "Puzzle and Arrow Duel separate by level", "Grammatical accessibility label", "Challenge Hub back navigation", "No redundant Start action", "No general History takeover", "No comparison callout", "No Run-status sections or labels", "No completed-Run count", "No cross-level ranking", "No global score", "No repeated Unrated badge"], ["Survival Hub", "Survival result", "Practice Home"], "contained"),
