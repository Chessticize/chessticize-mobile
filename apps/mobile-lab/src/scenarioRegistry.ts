...
const scenarioDefinitions: Record<LabScenarioId, LabScenarioMetadata> = {
  ...
  "practice-personal-best-records": defineScenario("practice-personal-best-records", "Practice", "Survival · records", "practice--personal-best-records", "Survival records live on a dedicated page reached from the Challenge Hub, keeping ordinary History focused on puzzle attempts. Compact cards show each available record's level and right-aligned saved best, grouped by type, without a comparison callout, in-progress Run management, or invented cross-level ranking.", "practice", ["Dedicated Survival page", "Challenge Hub back navigation", "No general History takeover", "Two-column portrait cards", "Four-column wide cards", "Right-aligned best scores", "No comparison callout", "No recommended-level styling", "No Run-status sections or labels", "Live bests included without status labels", "Puzzle records by level", "Arrow Duel records by level", "No completed-Run count", "No cross-level ranking", "No global score", "No repeated Unrated badge"], ["Survival Hub", "Survival result", "Practice Home"], "contained"),
