...
const scenarioDefinitions: Record<LabScenarioId, LabScenarioMetadata> = {
  ...
  "history-populated": defineScenario("history-populated", "History", "Populated history", "history--populated-history", "Existing populated History previews the 1.3.5 Incomplete result for puzzles left unfinished when a Sprint ends. Incomplete is neutral rather than Wrong, independently needs attention, and also carries Unclear and Slow when the elapsed time crossed the Slow line.", "history", ["Current History layout", "Neutral Incomplete result", "Gray circle and white dash", "Incomplete needs attention", "Slow Incomplete also Unclear", "Sprint source default", "Applied filter summary", "Curated tags"], ["Incomplete Replay decision", "Production outcome persistence", "Accuracy and ELO semantics"]),
