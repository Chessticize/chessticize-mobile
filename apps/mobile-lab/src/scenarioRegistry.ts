...
const scenarioDefinitions: Record<LabScenarioId, LabScenarioMetadata> = {
  ...
  "practice-timing-warning": defineScenario("practice-timing-warning", "Practice", "Active session · Slow", "practice--slow-warning", "The existing active-session baseline changes only the compact puzzle-time indicator to its Slow state.", "practice", ["Existing active session", "Sprint timer unchanged", "Compact amber Slow state", "Portrait board overlay", "Landscape right rail"], ["Production timer", "History persistence"], "contained"),
  "practice-timing-timeout": defineScenario("practice-timing-timeout", "Practice", "Active session · Timed out handoff", "practice--puzzle-timeout", "The existing active-session baseline briefly shows Timed out in the puzzle-time indicator, then resets it for the next puzzle.", "practice", ["Existing active session", "Brief Timed out feedback", "Automatic next-puzzle reset", "Portrait board overlay", "Landscape right rail"], ["Production sprint rule", "History persistence"], "contained"),
  ...
  "practice-active": defineScenario("practice-active", "Practice", "Active session", "practice--active-session", "Existing active Standard sprint with a compact puzzle elapsed-time indicator that does not add another layout bar.", "practice", ["Sprint timer", "Compact puzzle elapsed time", "Progress", "Board state", "Portrait board overlay", "Landscape right rail"], ["Sprint result"]),
  ...
  "history-populated": defineScenario("history-populated", "History", "Populated history", "history--populated-history", "Existing populated History with Slow and Timed out added to the current quick-filter row and matching attempt labels.", "history", ["Current History layout", "Slow filter", "Timed out filter", "Attempt status labels", "Rating chart", "Curated tags"], ["Attempt detail", "Review", "Production history query"]),
  ...
  "history-tactical-profile": defineScenario("history-tactical-profile", "History", "Populated history · Training focus", "history--training-focus", "The existing populated History adds one compact training recommendation based on theme accuracy and median correct time.", "history", ["Current History layout", "Compact training focus", "Theme accuracy", "Median correct time", "Train action"], ["Production aggregation", "Run creation", "Persistence"], "contained"),
