...
const scenarioDefinitions: Record<LabScenarioId, LabScenarioMetadata> = {
  "practice-home": defineScenario("practice-home", "Practice", "Home", "practice--home", "Practice Home keeps numeric Run Ratings, Training Focus, and Tactical Profile while delegating Review workload to the dedicated Review tab. It shows only the most recently touched paused Survival Run, including a newly reached best, with a visible count for the other paused Runs. Continue resumes that exact puzzle and the count opens the dedicated Survival Hub instead of turning Home into a list.", "practice", ["Existing saved Runs", "Numeric trailing Ratings", "No duplicate Review card", "Training Focus card", "Collecting-evidence state", "Tactical Profile entry", "Latest paused Survival Run", "New best saved while in progress", "Fixed challenge level", "Solved and mistake state", "Active time and sittings", "Other paused count", "Direct Continue", "Survival Hub entry", "Unrated status"], ["Survival Hub", "Run editor", "Review tab", "History", "Settings", "Tactical Profile"], "contained"),
  "practice-personal-best-hub": defineScenario("practice-personal-best-hub", "Practice", "Survival · Challenge Hub", "practice--personal-best-hub", "The one-page Survival Hub lists every resumable Run and lets the user choose Puzzle or Arrow Duel, an adjacent recommended level, or every other level supported by the installed Core Pack.", "practice", ["All paused Survival Runs", "Last-touched ordering", "Continue", "End and start over", "Puzzle and Arrow Duel selector", "Recommended Rating source", "Easier current harder levels", "Every supported More level", "600–699 through 2100–2200", "No numeric Rating input", "No time limit", "Three mistakes", "Unrated"], ["First-use guide", "Active Survival Run", "Practice Home", "Survival records"], "contained"),
  ...
  "practice-personal-best-guide": defineScenario("practice-personal-best-guide", "Practice", "Survival · first-use guide", "practice--personal-best-guide", "First-use guidance teaches one fixed level, three-mistake completion, active-time-only count-up, persistent pause, immediate best updates, separate per-level records, and unchanged Rating before play.", "practice", ["One level for the whole Run", "Three mistakes", "Wrong puzzles enter Review", "Unclear is independent", "No time limit", "Active-time context only", "Persistent pause and resume", "Best updates while playing", "Per-level record", "Rating unchanged", "Start Survival", "Not now"], ["Active Survival Run", "Practice Home"], "contained"),
  ...
  "history-personal-best": defineScenario("history-personal-best", "History", "Survival records", "history--personal-best-records", "History shows paused Survival Runs and each type-and-level best together. A new high is saved immediately while the Run remains in progress; pausing or ending never revokes it, and levels are never compared.", "history", ["Existing History", "In-progress Survival Runs", "Live best saved immediately", "Puzzle records by level", "Arrow Duel records by level", "Recommended-level highlight", "Completed Run count", "No cross-level ranking", "No global score", "Early end keeps reached best", "Attempt History remains available"], ["Survival result", "Survival Hub", "Replay puzzle"], "contained"),
