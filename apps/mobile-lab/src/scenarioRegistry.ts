...
const scenarioDefinitions: Record<LabScenarioId, LabScenarioMetadata> = {
  ...
  "practice-sprint-result-goal": defineScenario("practice-sprint-result-goal", "Practice", "Sprint result · Goal clarity", "practice--sprint-result-goal-clarity", "Failed Sprint Result that keeps Unclear and Needs review as separate counts while replacing mistake-only action copy with one neutral entry for three flagged replay attempts.", "practice", ["Solved 11", "Solve 15 to pass", "12 attempted", "Unclear count", "Needs review count", "Neutral replay entry", "Independent-state explanation"], ["Production result wiring", "History", "Review"], "contained"),
  "practice-sprint-result-replay": defineScenario("practice-sprint-result-replay", "Practice", "Sprint result · Flagged replay", "practice--sprint-result-flagged-replay", "The existing Review screen reached from Sprint Result replays three deterministic attempts and identifies Unclear, Needs review, and their overlap with independent context badges.", "practice", ["Sprint Result entry", "Three-attempt replay", "Unclear-only reason", "Needs-review-only reason", "Combined reasons", "Independent context badges", "Previous and next navigation"], ["Production replay selection", "Review scheduling", "Practice home"], "contained"),
