...
const scenarioDefinitions: Record<LabScenarioId, LabScenarioMetadata> = {
  ...
  "history-progress": defineScenario("history-progress", "History", "Tactical progress · improving strength", "history--tactical-progress", "History adds a dedicated Progress entry leading to a separate page that shows observed accuracy and completed-puzzle solve time changing over time.", "history", ["History Progress button", "Separate progress page", "Theme selector", "Progress over time", "Accuracy", "Solve time", "Balanced state"], ["Production navigation", "Historical aggregation", "Storage", "Training recommendation"], "contained"),
