...
const scenarioDefinitions: Record<LabScenarioId, LabScenarioMetadata> = {
  ...
  "practice-personal-best-leave": defineScenario("practice-personal-best-leave", "Practice", "Survival · paused", "practice--survival-leave-options", "The paused surface hides the puzzle like an ordinary Sprint pause, confirms that a newly reached best is already saved, hides the now-inapplicable header Pause action, and offers only Resume or Leave paused. Survival cannot be ended or reset manually.", "practice", ["Hidden puzzle and board", "New best 19 already saved", "Previous best 18", "Leave paused", "Exact-puzzle persistence", "Resume", "No redundant header Pause action", "No End Run action"], ["Paused Home", "Active Survival Run", "Survival records"], "contained"),
  "practice-personal-best-active": defineScenario("practice-personal-best-active", "Practice", "Survival · active Run", "practice--personal-best-active", "The existing board runs without a deadline or hard per-puzzle timeout. Its compact header keeps the solved count and shared Sprint mistake marks visible without repeating the untimed rule, while per-puzzle active time remains available for context and each newly reached high saves immediately.", "practice", ["Existing board session", "Survival title", "Full solved count", "No redundant timer metric", "No repeated Unrated badge", "Shared Sprint mistake marks", "Live per-level best", "Per-puzzle active time", "Pause hides puzzle", "No manual End Run", "No Slow scoring state"], ["Paused Home", "Survival result", "Review"], "contained"),
  "practice-personal-best-record": defineScenario("practice-personal-best-record", "Practice", "Survival · record mode", "practice--personal-best-record", "After Survival passes the standing best, the completed progress bar gives way to a one-line static milestone whose NEW BEST badge shows the live solved score, names the previous best, and stays aligned with the board.", "practice", ["New-best state", "Live score in NEW BEST badge", "Per-solve score update", "No completed progress bar", "Previous best", "One-line milestone", "No record animation", "Board remains primary"], ["Active Survival Run", "Survival result"], "contained"),
  "practice-personal-best-result": defineScenario("practice-personal-best-result", "Practice", "Survival · new record", "practice--personal-best-result", "A normal third-mistake ending celebrates the final best at one named level with the product-blue result treatment and shared monochrome trophy. Score stays primary; Review impact remains neutral; Play again repeats the same setup while Back or Done returns to Practice Home.", "practice", ["Product-blue new best", "Shared monochrome trophy", "Solved score", "Previous best", "Best already saved while playing", "Normal three-mistake ending", "Independent level record", "Accuracy", "Active time", "Sittings", "Neutral In Review card", "Replay mistakes", "Play again", "Back to Practice", "Done"], ["Replay", "Survival Hub", "Practice Home", "Survival records"], "contained"),
  ...
  "practice-personal-best-records": defineScenario("practice-personal-best-records", "Practice", "Survival · records", "practice--personal-best-records", "Survival records live directly on a dedicated full page reached from the Challenge Hub, keeping ordinary History focused on puzzle attempts. The page has no outer card; compact cards show each available record's level and right-aligned saved best, grouped by type, without a comparison callout, in-progress Run management, or invented cross-level ranking.", "practice", ["Dedicated full Survival page", "No outer page card", "Challenge Hub back navigation", "No general History takeover", "Two-column portrait cards", "Four-column wide cards", "Right-aligned best scores", "No comparison callout", "No recommended-level styling", "No Run-status sections or labels", "Live bests included without status labels", "Puzzle records by level", "Arrow Duel records by level", "No completed-Run count", "No cross-level ranking", "No global score", "No repeated Unrated badge"], ["Survival Hub", "Survival result", "Practice Home"], "contained"),
  ...
  "review-due": defineScenario("review-due", "Review", "Home", "review--due-queue", "The Review tab home keeps today's scheduled retries compact by default while leaving completed reviews open, and both Today sections remain smoothly collapsible. Filter options stay above the Review action; when they collapse, a single chip preserves only the selected filter, and the summary hides while the options are visible. Quick filters update the same two Today lists instead of switching interfaces. Stable section geometry, aligned counts, a distinct retry icon, prior attempts, misses, and recency remain visible.", "review", ["Review Home", "Due metrics", "Forecast", "Filter controls above Review action", "Collapsed selected-filter summary", "Main Review action", "Animated quick filters", "Same Today sections after filtering", "Today to review collapsed by default", "Completed today expanded by default", "Fixed-height section controls", "Animated height and fade", "Animated chevrons", "Aligned section counts and chevrons", "Blue retry icon", "Attempt count", "Miss count", "First-miss recency", "Last-retry recency"], ["Production review-history derivation", "Review session", "Practice"]),
