...
export const scenarioRegistry: Record<LabScenarioId, LabScenarioDefinition> = {
  ...
  "review-blunder-move-preview": defineScenario("review-blunder-move-preview", "Review", "Review blunder move preview", "review--blunder-move-preview", "Due Review entry that replays the original blunder before the user retries the puzzle as White.", "review", ["Blunder replay", "White King prompt icon", "Rounded prompt card above board", "Input lock"], ["Review queue"], { isNew: true, changeNote: "Issue #272: carry the revised King prompt card and puzzle-entry hierarchy into Review." }),
