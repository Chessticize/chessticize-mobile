...
const scenarioDefinitions: Record<LabScenarioId, LabScenarioMetadata> = {
  ...
  "practice-custom-setup": defineScenario(
    ...
    "practice",
    ["Required unique name", "Custom configuration", "24 curated themes", "Deterministic All-to-multiple selection", "All exclusivity", "Direct 600-2200 starting rating", "Add to Home"],
  ...
  "history-populated": defineScenario("history-populated", "History", "Populated history", "history--populated-history", "Existing populated History streamlined to one All or Needs attention view selector, with Slow and Timed out attempt labels retained.", "history", ["Current History layout", "Needs attention union", "Attempt status labels", "Applied filter summary", "Curated tags"], ["Attempt detail", "Review", "Production history query"]),
