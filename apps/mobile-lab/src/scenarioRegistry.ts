...
const scenarioDefinitions: Record<LabScenarioId, LabScenarioMetadata> = {
  ...
  "history-progress": defineScenario("history-progress", "History", "Tactical progress · improving strength", "history--tactical-progress", "History adds a dedicated Progress entry leading to a separate page that shows how one tactical strength changes over time.", "history", ["History Progress button", "Separate progress page", "Theme selector", "Strength over time", "Interpretable solve reliability", "No clear weakness state"], ["Production navigation", "Historical aggregation", "Storage", "Training recommendation"], "contained"),
  "history-progress-weakness": defineScenario("history-progress-weakness", "History", "Tactical progress · clear weakness", "history--tactical-progress-clear-weakness", "The separate History Progress page highlights one well-sampled theme only when it is clearly weaker than the user's comparable themes.", "history", ["History Progress button", "Separate progress page", "Weakness comparison", "Plain-language statistical confidence", "Evidence sample", "Strength trend"], ["Production navigation", "Statistical computation", "Storage", "Training recommendation"], "contained"),
