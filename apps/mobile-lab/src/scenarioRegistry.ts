...
const scenarioDefinitions: Record<LabScenarioId, LabScenarioMetadata> = {
  "practice-home": defineScenario("practice-home", "Practice", "Home", "practice--home", "Practice home keeps the existing Run, progress, and Training Focus contract without duplicating the workload owned by the dedicated Review tab, then adds one self-contained Personal Best entry beneath the saved Runs. It shows the current Standard Rating, locked 100-point puzzle band, current-band best, three-mistake ending, and Unrated promise before the user starts.", "practice", ["Bordered Run cards", "Numeric trailing Ratings", "Saved run selection", "Add Run entry", "Edit mode entry", "Progress summary", "No duplicate Review card", "Training Focus card", "Collecting-evidence state", "Tactical Profile entry", "Personal Best entry", "Current-band record", "Rating snapshot", "Locked 100-point band", "No timer", "Three-mistake ending", "Unrated status", "How it works", "Start challenge"], ["Personal Best first-use guide", "Run editor", "Review tab", "History", "Settings", "Tactical Profile"], "contained"),
  "practice-personal-best-guide": defineScenario("practice-personal-best-guide", "Practice", "Personal Best · first-use guide", "practice--personal-best-guide", "A first-use rule sheet explains the complete Personal Best contract before play: the current Rating selects one fixed 100-point band, wrong puzzles enter Review, Unclear stays independent, there is no scoring timer, and Rating never changes.", "practice", ["Set a personal best", "Current Rating snapshot", "Fixed puzzle band", "Three mistakes", "Wrong puzzles enter Review", "Unclear is not a mistake", "No timer", "Active-time context only", "Rating unchanged", "Start Personal Best", "Not now"], ["Personal Best active Run", "Practice Home"], "contained"),
  "practice-personal-best-active": defineScenario("practice-personal-best-active", "Practice", "Personal Best · active Run", "practice--personal-best-active", "The existing active board becomes a no-timer Personal Best Run. The header keeps solved count and three explicit mistake marks visible, while a below-board progress bar gives one stable self-referenced target without changing puzzle difficulty or Rating.", "practice", ["Existing board session", "Personal Best title", "No timer", "Unrated status", "Solved count", "Text and symbol mistake state", "Current-band best", "Progress to one above best", "Puzzle elapsed time for context", "Rating unchanged early-exit copy"], ["Personal Best result", "Review"], "contained"),
  "practice-personal-best-result": defineScenario("practice-personal-best-result", "Practice", "Personal Best · new record", "practice--personal-best-result", "A normal third-mistake ending celebrates a new current-band record without calling the Run failed. The result keeps score primary, reports active time and accuracy as context, confirms Rating is unchanged, and prioritizes replaying the three mistakes.", "practice", ["New personal best", "Solved score", "Previous best", "Normal three-mistake ending", "Current Rating and band", "Unrated status", "Accuracy", "Active time", "Best streak", "Three Review entries", "Replay mistakes", "Try again"], ["Replay", "Practice Home", "Personal Best History"], "contained"),
  ...
  "history-personal-best": defineScenario("history-personal-best", "History", "Personal Best records", "history--personal-best-records", "Existing History gains a compact current-level Personal Best card. It shows the band-specific best, completed-Run count, and recent completed scores while explicitly excluding ended-early Runs from record eligibility; attempt-level History remains below it.", "history", ["Existing History", "Current Rating level", "Locked band", "Band-specific best", "Completed Run count", "Recent score trend", "Ended-early eligibility note", "Attempt History remains available"], ["Personal Best result", "Replay puzzle", "Other Rating bands"], "contained"),
