...
const scenarioDefinitions: Record<LabScenarioId, LabScenarioMetadata> = {
  ...
  "review-filters": defineScenario("review-filters", "Review", "Filters", "review--filters", "Expanded Review filters use the shared short height-and-fade disclosure motion and show the active overdue control without repeating the selection in a separate summary-chip row.", "review", ["Animated Filter panel", "Mode, speed, and overdue filters", "Active filter control", "No duplicate summary chips"], ["Review session", "Practice"]),
