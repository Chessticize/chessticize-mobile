...
const scenarioDefinitions: Record<LabScenarioId, LabScenarioMetadata> = {
  ...
  "practice-arrow-duel-terminal-other-move": defineScenario("practice-arrow-duel-terminal-other-move", "Practice", "Arrow Duel · terminal other move", "practice--arrow-duel-terminal-other-move-no-reply", "A correct Qg7 checkmate choice is paired with Qf7 stalemate as the other move. Because that alternative position has no legal reply, the Storybook preview passes the puzzle immediately without a preparation cue, reply prompt, countdown, or timeout path.", "practice", ["Legal Qg7 and Qf7 candidates", "Correct Qg7 checkmate choice", "Qf7 stalemate detection", "Immediate pass", "No preparation cue", "No reply prompt", "No reply countdown", "No reply timeout"], ["Production terminal-position handling", "Review scheduling"], "contained"),
