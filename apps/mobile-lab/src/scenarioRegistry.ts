...
const scenarioDefinitions: Record<LabScenarioId, LabScenarioMetadata> = {
  ...
  "practice-personal-best-record": defineScenario("practice-personal-best-record", "Practice", "Survival · record mode", "practice--personal-best-record", "After Survival passes the standing best, the completed progress bar gives way to a compact static milestone that reuses the result screen's NEW BEST badge, names the previous best, and stays subordinate to the board.", "practice", ["New-best state", "No completed progress bar", "Shared NEW BEST badge", "Previous best", "No score duplication", "No record animation", "Board remains primary"], ["Active Survival Run", "Survival result"], "contained"),
