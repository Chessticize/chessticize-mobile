...
const scenarioDefinitions: Record<LabScenarioId, LabScenarioMetadata> = {
  ...
  "review-due": defineScenario("review-due", "Review", "Home", "review--due-queue", "The Review tab home shows today's scheduled retries between its main Review action and today's completed attempts, with a distinct retry icon and concise attempt recency.", "review", ["Review Home", "Due metrics", "Forecast", "Main Review action", "Today to review", "Blue retry icon", "First-miss recency", "Last-retry recency", "Completed today"], ["Production review-history derivation", "Review session", "Practice"]),
