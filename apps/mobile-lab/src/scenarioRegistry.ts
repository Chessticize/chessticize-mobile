...
const scenarioDefinitions: Record<LabScenarioId, LabScenarioMetadata> = {
  ...
  "practice-personal-best-records": defineScenario("practice-personal-best-records", "Practice", "Survival · records", "practice--personal-best-records", "Survival records live on a dedicated page reached from the Challenge Hub, keeping ordinary History focused on puzzle attempts. It shows saved bests grouped by type and level without duplicating the Hub's in-progress Run management or inventing cross-level ranking.", "practice", ["Dedicated Survival page", "Challenge Hub back navigation", "No general History takeover", "No in-progress Run section", "Live bests included without status labels", "Puzzle records by level", "Arrow Duel records by level", "Recommended-level highlight", "Completed Run count", "No cross-level ranking", "No global score", "No repeated Unrated badge"], ["Survival Hub", "Survival result", "Practice Home"], "contained"),
