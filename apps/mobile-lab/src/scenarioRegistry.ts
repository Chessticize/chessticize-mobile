...
const scenarioDefinitions: Record<LabScenarioId, LabScenarioMetadata> = {
  ...
  "practice-active-session-guide": defineScenario("practice-active-session-guide", "Practice", "First active-session guide", "practice--active-session-guide", "Board-free first-session guide shown before the timer starts, using compact session metrics plus real Slow and Unclear language without revealing a puzzle position.", "practice", ["No chessboard during guidance", "Timer starts after guide", "Solved, timer, and mistake metrics", "Slow automatically marks Unclear", "Mark as unclear button explanation", "Start Sprint"], ["Production onboarding persistence", "Active Sprint"], "contained"),
  "practice-arrow-duel-guide": defineScenario("practice-arrow-duel-guide", "Practice", "First Arrow Duel guide", "practice--arrow-duel-guide", "Short board-free mode-specific guide that explains how to compare the two candidate arrows without repeating the general Sprint rules.", "practice", ["No chessboard during guidance", "Two candidate illustration", "Only shown candidates count", "Timer starts after guide", "Start Arrow Duel"], ["Production onboarding persistence", "Arrow Duel Sprint"], "contained"),
  ...
  "settings-sprint-guidance": defineScenario("settings-sprint-guidance", "Settings", "Sprint guide reset", "settings--sprint-guide-reset", "Settings guidance action that makes the rules, active-session, and Arrow Duel guides available again without changing Runs, ratings, or History.", "settings", ["Show Sprint guides again", "Reset the full guidance set", "No confirmation for a reversible action", "Inline ready state", "Progress safety copy"], ["Production onboarding persistence", "Practice"], "contained"),
