...
const scenarioDefinitions: Record<LabScenarioId, LabScenarioMetadata> = {
  ...
  "practice-personal-best-records": defineScenario("practice-personal-best-records", "Practice", "Survival · records", "practice--personal-best-records", "Survival records live on a dedicated page reached from the Challenge Hub, keeping ordinary History focused on puzzle attempts. Paused Runs and completed bests remain grouped by type and level without cross-level ranking.", "practice", ["Dedicated Survival page", "Challenge Hub back navigation", "No general History takeover", "In-progress Survival Runs", "Live best saved immediately", "Puzzle records by level", "Arrow Duel records by level", "Recommended-level highlight", "Completed Run count", "No cross-level ranking", "No global score", "No repeated Unrated badge"], ["Survival Hub", "Survival result", "Practice Home"], "contained"),
