...
const scenarioDefinitions: Record<LabScenarioId, LabScenarioMetadata> = {
  ...
  "practice-tactical-profile-ranked": defineScenario("practice-tactical-profile-ranked", "Practice", "Tactical profile · ranked weaknesses", "practice--tactical-profile-ranked", "Tactical Profile with several ranked solve-rate and completed-speed recommendations.", "practice", ["Tactical Profile", "Ranked weaknesses", "Independent model heads", "Evidence diversity", "Focused Run preview entry", "Decline action"], ["Practice Home", "Recommendation explanation", "Focused Run preview"], "contained"),
  "practice-tactical-profile-rare-signal": defineScenario("practice-tactical-profile-rare-signal", "Practice", "Tactical profile · rare one-off mistake", "practice--tactical-profile-rare-signal", "Practice Home after one rare-theme mistake: the puzzle can be reviewed while the theme remains in evidence collection.", "practice", ["Existing Practice Home", "One-off rare signal", "Review-versus-theme distinction", "No focused recommendation"], ["Tactical Profile", "Review", "Mixed Runs"]),
  ...
  "practice-tactical-profile-focused-run": defineScenario("practice-tactical-profile-focused-run", "Practice", "Tactical profile · focused Run preview", "practice--tactical-profile-focused-run", "Focused Run preview with explicit primary, secondary, and mixed-control quotas plus selection guardrails.", "practice", ["Focused Run preview", "Explicit quotas", "Mixed-control allocation", "Puzzle selection guardrails", "Start CTA", "Decline action"], ["Tactical Profile", "Production Run start"], "contained"),
