...
const scenarioDefinitions: Record<LabScenarioId, LabScenarioMetadata> = {
  ...
  "practice-arrow-duel-guide": defineScenario("practice-arrow-duel-guide", "Practice", "Arrow Duel · after shared guide", "practice--arrow-duel-guide", "First-ever app entry through Arrow Duel presents the four responsive shared Active Session explanations, then a frozen real Arrow Duel composition explains that the two arrows are the user's two choices. In landscape, the callout stays in the board's empty lower lane instead of covering the production prompt.", "practice", ["Guides 1–4: responsive shared Active Session guidance", "Guide 5: frozen real Arrow Duel composition", "Height-aware portrait board and shared session components", "Single-line guide progress", "ARROW DUEL semantic callout", "The arrows show your two choices", "Landscape callout in the empty board lane", "Real candidate-arrow overlay", "Back returns from guide 5 to guide 4", "No real session position during guidance", "Start Arrow Duel after the final guide"], ["Production onboarding persistence", "Arrow Duel Sprint"], "contained"),
  "practice-arrow-duel-guide-only": defineScenario("practice-arrow-duel-guide-only", "Practice", "Arrow Duel · single first-use guide", "practice--arrow-duel-guide-only", "A user who already knows the shared Active Session controls sees one responsive Arrow Duel-specific guide the first time they enter the mode. The height-aware frozen real session composition identifies the two arrows as the only choices before the timer starts, with the landscape callout kept off the production prompt.", "practice", ["One guide: 1 of 1", "Height-aware frozen real Arrow Duel composition", "Shared session components", "Single-line guide progress", "ARROW DUEL semantic callout", "The arrows show your two choices", "Landscape callout in the empty board lane", "Real candidate-arrow overlay", "Only the two shown moves count", "No real session position during guidance", "Start Arrow Duel"], ["Production onboarding persistence", "Arrow Duel Sprint"], "contained"),
