...
const scenarioDefinitions: Record<LabScenarioId, LabScenarioMetadata> = {
  "practice-home": defineScenario("practice-home", "Practice", "Home", "practice--home", "Practice Home keeps numeric Run Ratings, Training Focus, and Tactical Profile while delegating Review workload to the dedicated Review tab. It shows only the most recently touched paused Survival Run, including a newly reached best, with a visible count for the other paused Runs. Continue resumes that exact puzzle and the count opens the dedicated Survival Hub instead of turning Home into a list.", "practice", ["Existing saved Runs", "Numeric trailing Ratings", "No duplicate Review card", "Training Focus card", "Collecting-evidence state", "Tactical Profile entry", "Latest paused Survival Run", "New best saved while in progress", "Fixed challenge level", "Solved and mistake state", "Active time and sittings", "Other paused count", "Direct Continue", "Survival Hub entry", "No decorative Survival badge"], ["Survival Hub", "Run editor", "Review tab", "History", "Settings", "Tactical Profile"], "contained"),
  "practice-personal-best-hub": defineScenario("practice-personal-best-hub", "Practice", "Survival · Challenge Hub", "practice--personal-best-hub", "The one-page Survival Hub lists every resumable Run, links to the dedicated Survival records page, and lets the user choose Puzzle or Arrow Duel plus any supported Core Pack level. In-progress Runs and More levels share one short animated disclosure contract with comfortable focus spacing. An existing type-and-level combination continues instead of offering a reset that discards mistakes.", "practice", ["All paused Survival Runs", "Last-touched ordering", "Animated in-progress disclosure", "Animated More levels disclosure", "Height fade and offset motion", "Animated chevrons", "Accessible collapsed content", "Comfortable focus spacing", "Dedicated records entry", "Continue only", "No End or reset action", "Puzzle and Arrow Duel selector", "Recommended Rating source", "Easier current harder levels", "Every supported More level", "600–699 through 2100–2200", "No numeric Rating input", "No time limit", "Three mistakes", "Compact core rules"], ["First-use guide", "Active Survival Run", "Practice Home", "Survival records"], "contained"),
  ...
  "practice-personal-best-records": defineScenario("practice-personal-best-records", "Practice", "Survival · records", "practice--personal-best-records", "Survival records live on a dedicated page reached from the Challenge Hub, keeping ordinary History focused on puzzle attempts. Its in-progress Runs use the same animated, accessible disclosure as the Hub; completed bests remain grouped by type and level without cross-level ranking.", "practice", ["Dedicated Survival page", "Challenge Hub back navigation", "No general History takeover", "Animated in-progress disclosure", "Accessible collapsed content", "In-progress Survival Runs", "Live best saved immediately", "Puzzle records by level", "Arrow Duel records by level", "Recommended-level highlight", "Completed Run count", "No cross-level ranking", "No global score", "No repeated Unrated badge"], ["Survival Hub", "Survival result", "Practice Home"], "contained"),
