...
const scenarioDefinitions: Record<LabScenarioId, LabScenarioMetadata> = {
  ...
  "history-filters": defineScenario("history-filters", "History", "Filters and active filters", "history--filters-and-active-filters", "Expanded History filter menu with range, Run, source, result, review state, side, and the complete curated theme catalog.", "history", ["Advanced filters", "All sources default", "24-theme catalog", "Active filter summary", "Reset"], ["Replay puzzle"]),
