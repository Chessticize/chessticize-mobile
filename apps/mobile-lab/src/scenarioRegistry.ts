...
const scenarioDefinitions: Record<LabScenarioId, LabScenarioMetadata> = {
  ...
  "practice-tactical-profile-collecting": defineScenario("practice-tactical-profile-collecting", "Practice", "Tactical profile · collecting evidence", "practice--tactical-profile-collecting-evidence", "Practice Home with an insufficient-data state and a detailed evidence snapshot showing which minimum checks are still short.", "practice", ["Existing Practice Home", "Collecting-evidence state", "Puzzle-variety gap", "Independent-Run gap", "Signal-clarity state", "No guaranteed focus"], ["Run start", "Review"]),
  "practice-tactical-profile-balanced": defineScenario("practice-tactical-profile-balanced", "Practice", "Tactical profile · no clear focus yet", "practice--tactical-profile-balanced", "Practice Home and Tactical Profile explain that enough evidence can still produce no clear focus when themes remain close.", "practice", ["Existing Practice Home", "Early-estimate balanced state", "Enough evidence checks", "No signal separation", "No forced action"], ["Run start", "Review"]),
  "practice-tactical-profile-solve-rate": defineScenario("practice-tactical-profile-solve-rate", "Practice", "Tactical profile · solve reliability", "practice--tactical-profile-solve-rate", "Tactical Profile shows why one solve-reliability signal became actionable without posterior percentages or label-based evidence.", "practice", ["Tactical Profile", "Solve reliability reason", "Puzzle-variety check", "Independent-Run check", "Signal-clarity check", "Focused Run preview entry", "Decline action"], ["Practice Home", "Recommendation explanation", "Focused Run preview"], "contained"),
  ...
  "practice-tactical-profile-task-families": defineScenario("practice-tactical-profile-task-families", "Practice", "Tactical profile · Puzzle solving and Arrow Duel", "practice--tactical-profile-task-families", "One Tactical Profile keeps Puzzle solving and Arrow Duel recommendations, evidence snapshots, Ratings, and Focused Runs in separate mode lanes.", "practice", ["Existing Practice Home", "Single focus card", "Mode-specific recommendation summary", "Puzzle solving and Arrow Duel selector", "Independent evidence snapshots", "Independent mode rankings", "Independent Rating anchors", "Mode-specific Focused Run preview"], ["Production navigation", "Production Run start"], "contained"),
  ...
  "practice-tactical-profile-explanation": defineScenario("practice-tactical-profile-explanation", "Practice", "Tactical profile · recommendation explanation", "practice--tactical-profile-explanation", "Plain-language recommendation explanation shows why the signal cleared the evidence checks while separating comparable performance, practical impact, and UI metadata.", "practice", ["Recommendation reason", "Comparable-puzzle baseline", "Puzzle-variety check", "Independent-Run check", "Signal-clarity check", "Excluded UI labels", "Focused Run preview entry", "Decline action"], ["Tactical Profile", "Focused Run preview", "Practice Home"], "contained"),
