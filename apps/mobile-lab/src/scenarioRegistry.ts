...
const scenarioDefinitions: Record<LabScenarioId, LabScenarioMetadata> = {
  ...
  "practice-first-sprint-guide": defineScenario("practice-first-sprint-guide", "Practice", "First Sprint guide", "practice--first-sprint-guide", "First-use Practice Home with an automatically expanded rule card that keeps every rule in one aligned badge and copy column while teaching the pass goal, time limit, mistake limit, solved-versus-attempted example, and the Slow-to-Unclear rule.", "practice", ["First-use guidance", "Aligned rule columns", "Solve 15 to pass", "Time and mistake limits", "Slow marks Unclear without a mistake", "Dismiss to persistent help entry"], ["Production onboarding state", "Persistence", "Active Sprint"], "contained"),
  ...
  "practice-active-session-guide": defineScenario("practice-active-session-guide", "Practice", "Active session · first-use guide", "practice--active-session-guide", "Four semantic first-use explanations shown before the Sprint begins. The frozen demonstration preserves the real Sprint hierarchy while using a height-aware portrait board and board-side landscape callouts so the taught control and guide navigation remain visible.", "practice", ["No real session chessboard during guidance", "Frozen real-Sprint composition", "Height-aware portrait board", "Board-side Slow and Unclear callouts in landscape", "Shared session header, prompt, timer, score, and Unclear components", "SPRINT HEADER, SLOW, TIMED OUT, and UNCLEAR guidance", "Current target stays bright while unrelated UI is dimmed", "Current-guide-only accessibility announcement", "Timed out is explained as a mistake, Unclear, and Review entry", "Start Sprint only after the final guide"], ["Production onboarding persistence", "Active Sprint"], "contained"),
  "practice-arrow-duel-guide": defineScenario("practice-arrow-duel-guide", "Practice", "Arrow Duel · after shared guide", "practice--arrow-duel-guide", "First-ever app entry through Arrow Duel presents the four responsive shared Active Session explanations, then a frozen real Arrow Duel composition explains the two candidate arrows with single-line 5 of 5 guide progress.", "practice", ["Guides 1–4: responsive shared Active Session guidance", "Guide 5: frozen real Arrow Duel composition", "Height-aware portrait board and shared session components", "Single-line guide progress", "ARROW DUEL semantic callout", "Real candidate-arrow overlay", "Back returns from guide 5 to guide 4", "No real session position during guidance", "Start Arrow Duel after the final guide"], ["Production onboarding persistence", "Arrow Duel Sprint"], "contained"),
  "practice-arrow-duel-guide-only": defineScenario("practice-arrow-duel-guide-only", "Practice", "Arrow Duel · single first-use guide", "practice--arrow-duel-guide-only", "A user who already knows the shared Active Session controls sees one responsive Arrow Duel-specific guide the first time they enter the mode. The height-aware frozen real session composition explains the only two candidate moves before the timer starts.", "practice", ["One guide: 1 of 1", "Height-aware frozen real Arrow Duel composition", "Shared session components", "Single-line guide progress", "ARROW DUEL semantic callout", "Real candidate-arrow overlay", "Only the two shown moves count", "No real session position during guidance", "Start Arrow Duel"], ["Production onboarding persistence", "Arrow Duel Sprint"], "contained"),
