...
const scenarioDefinitions: Record<LabScenarioId, LabScenarioMetadata> = {
  ...
  "history-filters": defineScenario("history-filters", "History", "Filters and active filters", "history--filters-and-active-filters", "Expanded History filter menu with an OR-based Attention flags group, clearer Review queue labels, and a default-collapsed theme catalog.", "history", ["Advanced filters", "Attention flags OR", "All sources default", "Collapsed 24-theme catalog", "Active filter summary", "Reset"], ["Replay puzzle"]),
