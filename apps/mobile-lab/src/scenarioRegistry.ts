...
const scenarioDefinitions: Record<LabScenarioId, LabScenarioMetadata> = {
  ...
  "practice-personal-best-record": defineScenario("practice-personal-best-record", "Practice", "Survival · record mode", "practice--personal-best-record", "After Survival passes the standing best, the completed progress bar gives way to a restrained record-mode aura. The card stays celebratory while every additional solve lands one brief score impact without covering the board.", "practice", ["New-best state", "No completed progress bar", "Persistent record aura", "Brief per-solve impact", "Current solved count", "Reduced-motion fallback", "Board remains unobstructed"], ["Active Survival Run", "Survival result"], "contained"),
