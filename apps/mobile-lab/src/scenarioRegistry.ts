...
export const scenarioRegistry: Record<LabScenarioId, LabScenarioDefinition> = {
  ...
  "practice-arrow-duel-prompt": defineScenario("practice-arrow-duel-prompt", "Practice", "Arrow Duel prompt layout", "practice--arrow-duel-prompt", "Active Arrow Duel session with an icon-free prompt while preserving its existing placement, copy, and top side marker.", "practice", ["Icon-free prompt", "Arrow Duel copy", "Existing prompt placement", "Candidate arrows"], ["Sprint result"], { isNew: true, changeNote: "Issue #272: remove the redundant prompt icon without changing Arrow Duel flow." }),
  "practice-blunder-move-preview": defineScenario("practice-blunder-move-preview", "Practice", "Blunder move preview", "practice--blunder-move-preview", "Standard puzzle entry that animates the opponent blunder before unlocking the white-to-move Board Placeholder.", "practice", ["Blunder replay", "Board-piece king badge", "Icon-free prompt above board", "Input lock"], ["Active sprint"], { isNew: true, changeNote: "Issue #272: animate the blunder, use the real board king in the side badge, and keep the prompt above the board without another icon or card." }),
  ...
  "review-blunder-move-preview": defineScenario("review-blunder-move-preview", "Review", "Review blunder move preview", "review--blunder-move-preview", "Due Review entry that replays the original blunder before the user retries the puzzle as White.", "review", ["Blunder replay", "Board-piece king badge", "Icon-free prompt above board", "Input lock"], ["Review queue"], { isNew: true, changeNote: "Issue #272: carry the revised puzzle-entry hierarchy into Review." }),
