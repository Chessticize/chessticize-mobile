...
const scenarioDefinitions: Record<LabScenarioId, LabScenarioMetadata> = {
  "practice-home": defineScenario("practice-home", "Practice", "Home", "practice--home", "Practice Home keeps numeric Run Ratings, Training Focus, and Tactical Profile while delegating Review workload to the dedicated Review tab. It shows only the most recently touched paused Personal Best Run, with a visible count for the other paused challenges; Continue resumes that exact puzzle and the count opens the dedicated Challenge Hub instead of turning Home into a list.", "practice", ["Existing saved Runs", "Numeric trailing Ratings", "No duplicate Review card", "Training Focus card", "Collecting-evidence state", "Tactical Profile entry", "Latest paused challenge", "Fixed challenge level", "Solved and mistake state", "Active time and sittings", "Other paused count", "Direct Continue", "Challenge Hub entry", "Unrated status"], ["Personal Best Challenge Hub", "Run editor", "Review tab", "History", "Settings", "Tactical Profile"], "contained"),
  "practice-personal-best-hub": defineScenario("practice-personal-best-hub", "Practice", "Personal Best · Challenge Hub", "practice--personal-best-hub", "A dedicated one-page Challenge Hub lists every resumable challenge and lets the user choose Puzzle or Arrow Duel, an adjacent recommended level, or another canonical 100-point level before starting. It keeps progressive difficulty and a global high score out of the contract.", "practice", ["All paused challenges", "Last-touched ordering", "Continue", "End and start over", "Puzzle and Arrow Duel selector", "Recommended Rating source", "Easier current harder levels", "More canonical levels", "No numeric Rating input", "No time limit", "Three mistakes", "Unrated"], ["First-use guide", "Active challenge", "Practice Home", "Personal Best records"], "contained"),
  "practice-personal-best-source-run": defineScenario("practice-personal-best-source-run", "Practice", "Personal Best · Rating source", "practice--personal-best-rating-source", "The Rating-source picker defaults Puzzle to Standard and Arrow Duel to its built-in Run, exposes only compatible mixed Runs, and explains that the source changes only the suggested level. It never borrows timing or silently chooses the highest, newest, or average Rating.", "practice", ["Compatible mixed Runs only", "Selected source", "Rating snapshot", "Source timing shown as provenance", "Suggested-level-only helper", "Focused and themed exclusion", "Remembered per challenge type", "Paused level stays locked"], ["Challenge Hub", "Run editor"], "contained"),
  "practice-personal-best-starting-level": defineScenario("practice-personal-best-starting-level", "Practice", "Personal Best · Standard has no games", "practice--personal-best-starting-level", "When built-in Standard has no completed games, Puzzle Challenge uses Standard's default Rating 600 and calls 600–699 a Starting level. It does not silently fall back to another custom Run; the user must explicitly choose Use another Run.", "practice", ["Standard default Rating 600", "Starting level language", "600–699", "No silent custom fallback", "Explicit Use another Run", "Challenge remains untimed and unrated"], ["Rating-source picker", "Challenge Hub"], "contained"),
  "practice-personal-best-arrow-duel": defineScenario("practice-personal-best-arrow-duel", "Practice", "Personal Best · Arrow Duel setup", "practice--personal-best-arrow-duel", "Arrow Duel is a separate Personal Best type with its own recommended Rating and level records. Every puzzle includes the candidate and required opponent reply; either stage can add exactly one mistake, and the reply phase can be paused and restored.", "practice", ["Arrow Duel type", "Arrow Duel Rating source", "Independent level records", "Candidate plus required reply", "One mistake maximum per puzzle", "No time limit", "Reply-phase persistence", "Rating unchanged"], ["Arrow Duel active challenge", "Challenge Hub", "Personal Best records"], "contained"),
  "practice-personal-best-guide": defineScenario("practice-personal-best-guide", "Practice", "Personal Best · first-use guide", "practice--personal-best-guide", "First-use guidance teaches one fixed level, three-mistake completion, active-time-only count-up, persistent pause, separate per-level records, and unchanged Rating before play.", "practice", ["One level for the whole Run", "Three mistakes", "Wrong puzzles enter Review", "Unclear is independent", "No time limit", "Active-time context only", "Persistent pause and resume", "Per-level record", "Rating unchanged", "Start Personal Best", "Not now"], ["Personal Best active Run", "Practice Home"], "contained"),
  "practice-personal-best-active": defineScenario("practice-personal-best-active", "Practice", "Personal Best · active Run", "practice--personal-best-active", "The existing board runs without a deadline or hard per-puzzle timeout. Per-puzzle active time counts up for context, while leaving pauses the exact board and the overflow keeps early End Run explicit and record-ineligible.", "practice", ["Existing board session", "Personal Best title", "No time limit", "Unrated status", "Solved count", "Three mistake marks", "Per-level best", "Per-puzzle active time", "Pause on leave", "Explicit End Run", "No Slow scoring state"], ["Paused Home", "Personal Best result", "Review"], "contained"),
  "practice-personal-best-result": defineScenario("practice-personal-best-result", "Practice", "Personal Best · new record", "practice--personal-best-result", "A normal third-mistake ending celebrates a record at one named level. Score stays primary; active time and sittings are context only; Play again repeats the same setup while Change challenge returns to the Hub.", "practice", ["New best at named level", "Solved score", "Previous best", "Normal three-mistake ending", "Independent level record", "Unrated status", "Accuracy", "Active time", "Sittings", "Review mistakes", "Play again", "Change challenge"], ["Replay", "Challenge Hub", "Practice Home", "Personal Best records"], "contained"),
  ...
  "history-personal-best": defineScenario("history-personal-best", "History", "Personal Best records", "history--personal-best-records", "History shows paused challenges as In progress and completed Personal Bests by challenge type and canonical level. A strong lower-level score never replaces a harder-level record, Puzzle never compares with Arrow Duel, and ended-early Runs never set a best.", "history", ["Existing History", "In-progress paused Runs", "Paused PB eligibility", "Puzzle records by level", "Arrow Duel records by level", "Recommended-level highlight", "Completed Run count", "No cross-level ranking", "No global score", "Ended-early eligibility note", "Attempt History remains available"], ["Personal Best result", "Challenge Hub", "Replay puzzle"], "contained"),
