...
describe('Android Play release contract', () => {
  it('pins the proposed Play release to public version 1.3.5 build 14', () => {
    ...
    expect(sourceTag).toBe('android-v1.3.5-build-14');
    ...
    expect(releaseNote).toContain('Public version: `1.3.5`');
    expect(releaseNote).toContain('Build or version code: `14`');
    ...
    expect(storeCopy).toContain('Incomplete');
    expect(storeCopy).toContain('without counting it as a mistake');
    expect(storeCopy).toContain('History');
    expect(storeCopy).toContain('Arrow Duel Replay');
    expect(storeCopy).toContain('without shifting the board');
